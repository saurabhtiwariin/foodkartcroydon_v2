...
/**
 * The persistent class for the apptl__deliverable database table.
 * 
 */
@Entity
@Table(name="apptl__deliverable")
@NamedQuery(name="ApptlDeliverable.findAll", query="SELECT a FROM ApptlDeliverable a")
public class ApptlDeliverable implements Serializable {
	...
	@OneToMany(mappedBy="apptlDeliverable")
	private List<AppDeliverable> appDeliverables;

	public ApptlDeliverable() {
	}
	...
	public AppDeliverable addAppDeliverable(AppDeliverable appDeliverable) {
		...
		appDeliverable.setApptlDeliverable(this);
	...
	public AppDeliverable removeAppDeliverable(AppDeliverable appDeliverable) {
		...
		appDeliverable.setApptlDeliverable(null);
